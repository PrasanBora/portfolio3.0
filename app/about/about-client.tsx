...
export default function AboutClient() {
  return (
    <article className="mx-auto w-full max-w-5xl px-4 section-padding md:px-6">
      <motion.header
      ...
      <section className="mt-10" aria-labelledby="writing-heading">
        <motion.div
          initial={{ opacity: 0, y: 14 }}
          whileInView={{ opacity: 1, y: 0 }}
          ...
          <Card>
            <CardHeader>
              <CardTitle id="writing-heading">Writing</CardTitle>
            </CardHeader>
            <CardContent>
              <Link
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <span className="inline-flex items-center gap-1 mt-2 text-xs text-muted-foreground">
                    dev.to
                    <ExternalLink className="size-3 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" aria-hidden />
                  </span>
                </div>
              </Link>
            </CardContent>
      ...
      <section className="mt-10" aria-labelledby="career-heading">
        <motion.div
          initial={{ opacity: 0, y: 14 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, amount: 0.3 }}
          ...
          <Card>
            <CardHeader>
              <CardTitle id="career-heading">Where I&apos;ve been</CardTitle>
            </CardHeader>
            <CardContent>
              <CareerTimelineFixed
                items={[
