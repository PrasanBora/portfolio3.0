...
import { ArrowRight, Sparkles, Server, Smartphone, Code2 } from "lucide-react";
...
const highlights = [
  {
    icon: Sparkles,
    title: "AI Agents",
    description: "Automated 80% of manual ops",
  },
  {
    icon: Server,
    title: "Backend APIs",
  ...
  },
  {
    icon: Smartphone,
    title: "Mobile Apps",
    description: "React Native, shipped fast",
  },
  {
    icon: Code2,
    title: "Web Apps",
          ...
          <motion.div
            ...
            <div className="relative aspect-4/5 rounded-3xl overflow-hidden shadow-2xl shadow-primary/10">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <p className="text-lg font-semibold text-foreground">Prasan Bora</p>
